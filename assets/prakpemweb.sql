...
CREATE TABLE `film` (
  ...
  `genre` set('History','Action','Biography','Drama','Romance','Family','war') COLLATE utf8mb4_general_ci DEFAULT NULL
...
(7, 'A Man Called Ahok', 'assets/image 36 (5).png', 'Depicts the life of the titular former governor of Jakarta before he ran for office, Ahok learned a lot about discipline from his father who ran a mining business in Belitung while dealing with various corrupt people.', 2018, 'Putrama Tuta', 'Danny Jaka Sembada, Ilya Sigma, Putrama Tuta', 'Daniel Mananta, Kin Wah Chew, Eric Febrian', '1h 42m', 'Biography,Drama'),
(8, 'Jokowi', 'assets/image 36 (6).png', 'Story of the Indonesian President\'s life before he become famous.', 2013, 'Azhar kinoi Lubis', 'Joko Nugroho, Azhar kinoi Lubis', 'T. Rifnu Wikana, Prisia Nasution, Susilo Badar', '1h 57m', 'Biography,Drama'),
(9, 'Merah Putih', 'assets/image 36 (7).png', 'A band of Indonesian men bond together as cadets, survive a massacre, and fight on as guerrilla soldiers against the Dutch despite their conflicts and deep differences in social class.', 2009, 'Yadi Sugandi', 'Conor Allyn, Rob Allyn', 'Donny Alamsyah, Rahayu Saraswati, Lukman Sardi', '1h 48m', 'Action,Drama,war'),
...
(33, 'afiftharavi@gmail.com', 'user', '123', 'user');
